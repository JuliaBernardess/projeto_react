...
function FormularioPostagem() {
  ...
  useEffect(() => {
    setPostagem({
      ...postagem,
      //Esse useEffect estará atualizando o objeto postagem, de acordo com o tema escolhido ..como se fosse o objeto fazendo o relacionamento de postagem com o tema, de acordo com oq o usuário escolher. 
      tema: tema,
    });
  }, [tema]);
